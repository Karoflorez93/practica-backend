...
// el method GET
// El primer parametro establece el path (ruta) de
...
app.put('/api/v1/usuarios/:cedula' , (req, res) => {
    ...
    const cedula = req.params.cedula
    res.json({
        mensaje: `usuario cpn cedula ${cedula} actualizado`
    })
})

// patch: actualiza algunos campos de nuestro elemento
...
//Le indicamos a niestra API que empiece a escuchar peticiones
// en el puerto 300 y cuando se encienda nos muestre el mensaje
